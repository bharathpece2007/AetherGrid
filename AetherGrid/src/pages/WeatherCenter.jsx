...
import { 
  ...
  RefreshCw, CloudSun, Calendar, Zap, AlertTriangle
} from 'lucide-react';
import { fetchCurrentWeather, fetchForecast } from '../services/weatherService';
import { AreaChart, Area, XAxis, YAxis, CartesianGrid, Tooltip, ResponsiveContainer } from 'recharts';
import './Admin.css';

const WeatherCenter = ({ theme }) => {
  ...
  return (
    <div className="admin-tab-container fade-slide-up flex flex-col gap-xl">
      <div className="tab-header flex justify-between items-center px-lg mb-xl">
        <div>
          <h1 className="flex items-center gap-md m-0"><CloudSun className="text-gold" /> Weather Intelligence Center</h1>
        ...
        <div className="flex items-center gap-lg">
           <div className="text-right">
              <div className="text-[10px] font-black uppercase text-muted">Last System Sync</div>
      ...
      <div className="grid-3 gap-xl px-lg">
        ...
        <div className="surface-card p-xl flex flex-col gap-lg overflow-hidden border border-white/10">
          ...
          <div className="flex flex-col gap-md overflow-y-auto pr-sm h-full">
            {forecast?.list?.slice(0, 8).map((item, i) => (
              <div key={i} className="flex justify-between items-center p-md bg-white/5 rounded-2xl border border-white/5 hover:border-gold/20 transition-all">
      ...
      <div className="grid-2 gap-xl px-lg">
        ...
        <div className="surface-card p-xl border border-white/10">
        ...
        <div className="surface-card p-xl flex flex-col border border-white/10">
