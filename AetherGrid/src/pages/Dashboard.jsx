    ...
    <div className="dashboard-container">
      ...
      <div className="dashboard-hero">
        <div className="hero-text">
          <h1>{isAdmin ? 'Grid Macro-Overview' : 'Live Consumption'}</h1>
          <p className="subtitle">
            {isAdmin 
              ? <>Real-time systemic analysis of the Virtual Power Plant network.<br/>Managing stability across all unified DER nodes.</>
              : <>Real-time monitoring of your residential DER node.<br/>Balancing localized generation with grid demand response.</>
            }
          </p>
        </div>
